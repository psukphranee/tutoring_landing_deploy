...
export default function Location() {
  ...
  const scrollToServices = () => {
    ...
    return (
      <section className="my-6 w-screen" id="Location">
        <div className="h-screen flex flex-col bg-gray-900 py-2 sm:py-32">
          <div className="overflow-y-scroll my-2 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex item-center justify-center py-6">
            <button
              onClick={null}
              className="w-20 mx-4 rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              &larr;
            </button>
            <button
