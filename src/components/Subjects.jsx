...
export default function Subjects() {
  ...
  return (
    <div className="flex flex-col justify-end h-screen py-8 sm:py-8" id="Subjects">
      <div className="overflow-y-scroll h-[80vh] mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <dl className="col-span-2 grid grid-cols-1 gap-x-8 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:gap-y-16">
            {data.Subjects.map((feature) => (
              <div key={feature.name} className="relative pl-9">
                ...
                <dd className="mt-2 lg:block">{feature.description}</dd>
              </div>
            ))}
          </dl>
        </div>
